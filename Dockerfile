...
WORKDIR /go/src/github.com/alcarria/data-marketplace-chaincode-rest
...
WORKDIR /root/
COPY --from=builder /go/src/github.com/alcarria/data-marketplace-chaincode-rest/bin/chaincode-rest .
